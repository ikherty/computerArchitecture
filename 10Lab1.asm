...
start:
	mov RBX, table; регистр, где находится таблица для xlatb
 ...
 .loop1:
	...
	test RBP,RBP; проверяем, что в ребепе 0, результат кладем в zf, если обработалось не все, то начать заново
	jne .loop1; if zf != 0 начать цикл заново
.exit:
	;PRINT
